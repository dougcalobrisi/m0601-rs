...
///
/// Telemetry retention (temperature from query replies, hi-res angle from
/// drive replies) lives in [`m0601::Telemetry`] — the 50 Hz loop here is
/// exactly the drive-every-cycle, query-every-10th shape its docs describe.
pub struct Shared {
